...
```ts
import { useListAllProjects, useCreateNewTask, useGetMyTasks, useAddCommentToIdea } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useAddCommentToIdea(addCommentToIdeaVars);
...
```js
import { listAllProjects, createNewTask, getMyTasks, addCommentToIdea } from '@dataconnect/generated';
...
// Operation AddCommentToIdea:  For variables, look at type AddCommentToIdeaVars in ../index.d.ts
