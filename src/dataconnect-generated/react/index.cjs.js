const { listAllProjectsRef, createNewTaskRef, getMyTasksRef, addCommentToIdeaRef, connectorConfig } = require('../index.cjs.js');
...
exports.useAddCommentToIdea = function useAddCommentToIdea(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
    return addCommentToIdeaRef(dcInstance, vars);
  }
  return useDataConnectMutation(refFactory, inputOpts, CallerSdkTypeEnum.GeneratedReact);
}
